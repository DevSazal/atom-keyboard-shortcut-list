...
These are the list of keyboard shortcuts for the [Atom text editor](https://atom.io) that I [collected](https://github.com/nwinkler/atom-keyboard-shortcuts) as it's valuable and use a lot. Feel free to fork the page and add your own favorites. Pull Requests welcome!
...
Please feel free to add the Windows or Mac or Linux shortcuts.
